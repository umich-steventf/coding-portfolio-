...
$SOURCE = "\\lsa-chem.m.storage.umich.edu\lsa-chem\dept\Teaching Lab\bt_nmr"
$Destination = "\\lsa-chem.m.storage.umich.edu\lsa-chem\dept\Teaching Lab\bt_nmr\Archive"
